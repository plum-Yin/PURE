...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='scierc', choices=['ace04', 'ace05', 'scierc'])
    parser.add_argument('--data_dir', type=str, default='scierc_data/processed_data/json/',
                        help="path to the preprocessed dataset")
    parser.add_argument('--output_dir', type=str, default='scierc_models/ent-scib-ctx0/',
